select t.cod,
  ...
  from (select odc.tert_id idtert, odc.data_dec, max(odc.note_dec) note_dec
         
           from ordine_deconectare odc, contracte_furnizare cf
       ...
       and odc.executat_dec = :p_executat_dec
          ...
          group by odc.tert_id, odc.data_dec
