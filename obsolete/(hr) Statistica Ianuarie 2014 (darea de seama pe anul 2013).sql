select --a.matricol, a.nume, a.prenume,
       ...
       'PCT1',       
       decode(asa.unitier_cod,'142','2.CANAL-EPURARE','255','2.CANAL-EPURARE','256','2.CANAL-EPURARE','143','2.CANAL-EPURARE','257','2.CANAL-EPURARE','258','2.CANAL-EPURARE',
              '132','3.PROIECTE-UTILITARE','182','3.PROIECTE-UTILITARE','183','3.PROIECTE-UTILITARE','184','3.PROIECTE-UTILITARE',
              '1.CAPTARE-TRATARE') GRUP_UI, 
...
where a.marca=asa.angajat_matricol 
   --   and a.activ ='D'
      and asa.perang_id between  3005 and 3206 
