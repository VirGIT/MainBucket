...
--delete valori_variabila_angajat where perang_id= 2805 and varang_cod = 'PREM_8_MARTIE'

--select * from valori_variabila_angajat where angajat_matricol = 2306 and perang_id = 2805 and varang_cod = 'PREM_8_MARTIE'
