select --a.matricol, a.nume, a.prenume,
       ...
       decode(asa.unitier_cod,'142','2.TRATARE-CAPTARE','255','2.TRATARE-CAPTARE','256','2.TRATARE-CAPTARE','143','2.TRATARE-CAPTARE','257','2.TRATARE-CAPTARE','258','2.TRATARE-CAPTARE',
              '281','2.TRATARE-CAPTARE','276','2.TRATARE-CAPTARE','132','3.PROIECTE-UTILITARE','182','3.PROIECTE-UTILITARE','183','3.PROIECTE-UTILITARE','184','3.PROIECTE-UTILITARE','273','3.PROIECTE-UTILITARE','278','3.PROIECTE-UTILITARE',
              '1.RESTUL') GRUP_UI, 
...
where a.marca=asa.angajat_matricol 
   --   and a.activ ='D'
      and asa.perang_id between  3226 and 3446 
...
where a.marca=asa.angajat_matricol 
   --   and a.activ ='D'
      and asa.perang_id between 3226 and 3426 -- (ianuarie - noiembrie, ca sa cuprinda doar premiile de 8 martie, nu si cele de pom de iarna, trecute pe aceeasi variabila in decembrie) 
      and vva3.ANGAJAT_MATRICOL=a.MATRICOL and VVA3.PERANG_ID = ASA.PERANG_ID
      -- ===============================================
...
where a.marca=asa.angajat_matricol 
   --   and a.activ ='D'
      and asa.perang_id = 3446  -- Premiile copiilor de craciun (doar pe luna decembrie)
      and vva3.ANGAJAT_MATRICOL=a.MATRICOL and VVA3.PERANG_ID = ASA.PERANG_ID
      -- ===============================================
      and vva3.VARANG_COD='PREM_8_MARTIE'
      -- ===============================================      
